...
{% raw %}
<iframe src="./content/day01/7/embed.html" width="100%" height="450" frameborder="no"></iframe>
{% endraw %} 
...
```
This looks fantastic. The effect is incredibly strong—it looks like an oil painting that has been left out in the rain, or a digital ghost. The high contrast of the original photo really helped; the bright highlights on the face created those long, clean streaks, while the shadows created the darker "drips."

This perfectly meets the Week 7 deliverable: "One pixel-based sketch... showing original image + transformation".

Step 3: Documenting Week 07
Let's get this into your journal. I have drafted the entry to answer the specific prompts from your slides regarding "pixels as material" and "unexpected aesthetics".

Action:

Save the melted image as output_07.png in your journal/images/ folder.

Make sure the original portrait.jpg is also in that folder (so you can display the "Before & After").

Create/Open journal/week_07.md and paste the text below.
...
{% raw %}
<iframe src="./content/day01/07/embed.html" width="100%" height="450" frameborder="no"></iframe>
{% endraw %} 
